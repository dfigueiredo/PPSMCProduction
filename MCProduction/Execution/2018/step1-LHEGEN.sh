...
cmsDriver.py Configuration/GenProduction/python/PPS-RunIISummer20UL18pLHEGEN-00001-fragment-XZ.py --python_filename PPS-RunIISummer20UL18pLHEGEN-00001_1_cfg.py --eventcontent LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier LHE --fileout file:PPS-RunIISummer20UL18pLHEGEN-00001_0.root --conditions 106X_upgrade2018_realistic_v4 --step NONE --filein "/store/group/phys_exotica/PPS-Exo/LHESource/toy_mc_pps_XZ.lhe" --era Run2_2018 --no_exec --mc -n $EVENTS || exit $? ;

cmsDriver.py Configuration/GenProduction/python/PPS-RunIISummer20UL18pLHEGEN-00001-fragment-XH.py --python_filename PPS-RunIISummer20UL18pLHEGEN-00001_1_cfg.py --eventcontent LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier LHE --fileout file:PPS-RunIISummer20UL18pLHEGEN-00001_0.root --conditions 106X_upgrade2018_realistic_v4 --step NONE --filein "/store/group/phys_exotica/PPS-Exo/LHESource/toy_mc_pps_XH.lhe" --era Run2_2018 --no_exec --mc -n $EVENTS || exit $? ;
